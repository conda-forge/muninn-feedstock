...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/muninn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13570&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/muninn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `muninn` can be installed with:

```
conda install muninn
```

It is possible to list all of the versions of `muninn` available on your platform with:
